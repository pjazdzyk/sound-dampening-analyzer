...
namespace SoundDoc.Tests.Hydraulics
{
    public class HydraulicsTests
    {
        ...
        public void HydraulicsDefaultConstructorTests() {
            ...
            // ACT
            var hydraulics = new Core.Data.HydraulicModels.Hydraulics();
        ...
        {        
            ...
            // Act
            var hydraulics = new Core.Data.HydraulicModels.Hydraulics(volFlow, dim1, dim2);
            var actDim1 = hydraulics.InDim1;
            var actDim2 = hydraulics.InDim2;
            var actArea = hydraulics.InArea;
            var actVolFlow = hydraulics.InVolFlow;
        ...
        {
            //Assert
            Assert.ThrowsAny<Exception>(() => new Core.Data.HydraulicModels.Hydraulics(volFlow,dim1,dim2));
        }
