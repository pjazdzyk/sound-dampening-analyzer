...
namespace NoiseAnalyzer.Tests.RoomModels
{
    public class RoomModelTests
    {
        ...
        public void RoomModelsTest()
        {
            ...
            var ductAsRoomTerminal = TerminalAdapter.FromAcuItem(duct).WithLocation(location).WithMountAngle(mountAngle).WithGrossDischargeArea(grossDiscArea);
            ...
            var office = RoomModel.Create().WithName("Office");
